                ...
                <?php if (!empty($dentists)) : ?>
                    <?php foreach ($dentists as $dentist) : ?>
                        <tr>
                            ...
                            <td>
                                <!-- Edit Button -->
                                <button class="btn btn-primary" onclick="editDentist(<?php echo $dentist['id']; ?>, '<?php echo htmlspecialchars($dentist['name']); ?>')">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                                <!-- Delete Button -->
                                <button class="btn btn-danger" onclick="deleteDentist(<?php echo $dentist['id']; ?>)">
